                    ...
                    <div class="row">
                        <div class="col-md-6">
							<div class="form-group input-group-outline mt-3" id="imageInput1">
                                ...
                                <input type="hidden" name="cashback_id" value="{{$detail->id}}">
                                <input type="hidden" name="business_category_id" value="{{$detail->business_category_id}}">
                                <input type="text" readonly class="form-control" value="{{$detail->businessCategory->name}}">
