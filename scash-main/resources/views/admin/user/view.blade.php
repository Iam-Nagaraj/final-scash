...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
        <h1 class="h3 mb-0 main-heading">User Details</h1>
        <!-- <a
                href="#"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form_card card shadow mb-4 p-5 user_details">
                <div class="row">
                    <div class="col-md-12">
                        <h3>User Details</h3>
                        <form>
                            ...
                            <div class="row">
                                ...
                                <button type="" class="back_btn">Back</button>
                                <button type="submit" class="save_btn">Edit Details</button>
                                </div>
                                </div>
                            </div>
                        </form>
