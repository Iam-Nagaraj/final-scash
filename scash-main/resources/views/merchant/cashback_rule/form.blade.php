                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group input-group-outline mt-3">
                                ...
                                @if($cashback_rule)
                                <input class="form-control" name="standard_cashback_percentage" type="number"  min="0"  step="any"value="{{ old('standard_cashback_percentage', $cashback_rule->standard_cashback_percentage ?? '') }}">
                                @else
