    ...
    <div class="form_card merchant_form card shadow mb-4 p-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6 d-flex justify-content-start"><img src="{{$userModel->image_url}}" class="image-fluid" alt=""></div>
                    <div class="col-md-6 d-flex justify-content-end" id="qrcode"></div>
                </div>
                <form id="cashback-form" method="POST" action="{{route('merchant.store.update')}}" enctype="multipart/form-data">
					@csrf
                    <input value="{{$detail->uuid}}" name="id" type="hidden" >
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control" name="phone" type="number" onKeyUp="this.value = this.value.slice(0, 10)"  value="{{$detail->phone}}" >
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <strong class="text-danger is-invalid" id="picture"></strong>
                            </div>
                        </div> -->
