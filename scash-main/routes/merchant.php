...
Route::group(['domain' => config('services.url.merchant')], function () {
	...
	Route::group(['middleware' => 'auth', 'as' => 'merchant.'], function () {
		...
		Route::group(['prefix' => 'store'], function () {
			...
			Route::get('/cashback/{id}', [StoreController::class, 'cashback'])->name('store.cashback');
			Route::post('/cashback/save', [StoreController::class, 'cashbackSave'])->name('store.cashback.rule.save');
