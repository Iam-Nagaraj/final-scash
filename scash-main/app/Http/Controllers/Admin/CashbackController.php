...
class CashbackController extends Controller
{
	...
	{
		try {
			$data['businessCategory'] = BusinessSubCategory::get();
	...
	{
		$data['businessCategory'] = BusinessSubCategory::where('id', $request->id)->first();
	...
	public function create()
	{
		try {
			...
			$data['businessCategory'] = BusinessSubCategory::whereNotIn('id',$cashback_business_categories)->get();
